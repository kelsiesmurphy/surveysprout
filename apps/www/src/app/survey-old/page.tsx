...
import SurveyPagination from "~/src/components/survey-old/SurveyPagination";
import { z } from "zod";
import {
  Banana,
  Ear,
...
import SocialOptions from "~/src/components/survey-old/SocialOptions";
import Link from "next/link";
import Options from "~/src/components/survey-old/Options";
import TextAreaOther from "~/src/components/survey-old/TextAreaOther";
import SliderScreen from "~/src/components/survey-old/Slider";
import { useRouter } from "next/navigation";
import SurveyStart from "~/src/components/survey-old/SurveyStart";
